...
class VibeStyleSuggestionCard extends StatefulWidget {
  ...
  final bool enabled;
  @override
  State<VibeStyleSuggestionCard> createState() =>
      _VibeStyleSuggestionCardState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            m.hasControls ? l.vibeFamily_controlled : l.vibeFamily_visualOnly,
          ...
          if (m.examples.length > 1)
            Row(
              ...
              children: [
                IconButton(
                  tooltip: l.vibeFamily_previousPair,
                ...
                IconButton(
                  tooltip: l.vibeFamily_nextPair,
                  onPressed: _example + 1 < m.examples.length
                      ? () => setState(() => _example++)
                      : null,
          ...
          Text(
            l.vibeFamily_dimensions(
              m.dimensions[0].toStringAsFixed(2),
              m.dimensions[1].toStringAsFixed(2),
              m.dimensions[2].toStringAsFixed(2),
              m.dimensions[3].toStringAsFixed(2),
            ),
          ),
          const SizedBox(height: 8),
          Wrap(
            ...
            children: [
              FilledButton.tonal(
                onPressed: widget.enabled ? widget.onMerge : null,
                child: Text(l.vibeFamily_merge),
              ),
              TextButton(
                onPressed: widget.enabled ? widget.onSeparate : null,
