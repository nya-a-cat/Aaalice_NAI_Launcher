...
void main() {
            ...
            actions: [TextButton(
              ...
              onPressed: () => showDialog<void>(
                ...
                builder: (communityContext) {
                  final leaveCommunity = galleryOwnedOverlayExit(communityContext);
                  return AlertDialog(
                    ...
                    actions: [TextButton(
                      ...
                      onPressed: () => showDialog<void>(
                        ...
                        builder: (detailContext) {
                          leaveDetail = galleryOwnedOverlayExit(detailContext,
                            onExit: () { leaves++; leaveCommunity(); });
                          return AlertDialog(
  ...
  testWidgets('a page context cannot remove a page route', (tester) async {
    ...
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(body: Builder(builder: (context) => TextButton(
        onPressed: galleryOwnedOverlayExit(context, onExit: () => leaves++),
